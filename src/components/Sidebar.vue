...
<template>
  <aside class="sidebar">
    ...
    <div class="nav-section">
      ...
      <button
        :class="['nav-item', { active: isActive('your-library') }]"
        @click="emit('update:view', 'your-library')"
        title="Your Library"
      >
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 19V5a2 2 0 0 1 2-2h13.4a.5.5 0 0 1 .49.6l-2 10a.5.5 0 0 1-.49.4h-10M4 19a2 2 0 0 0 2 2h14c1.1 0 2-.9 2-2M4 19h14"/></svg>
        <span>Your Library</span>
      </button>

      <button
        :class="['nav-item', { active: isActive('liked-songs') }]"
        @click="emit('update:view', 'liked-songs')"
        title="Liked Songs"
      >
